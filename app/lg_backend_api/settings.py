...
ACCOUNT_EMAIL_CONFIRMATION_ANONYMOUS_REDIRECT_URL = os.getenv("FRONTEND_EMAIL_CONFIRMATION_URL")
ACCOUNT_EMAIL_CONFIRMATION_AUTHENTICATED_REDIRECT_URL = os.getenv("FRONTEND_EMAIL_CONFIRMATION_URL")
